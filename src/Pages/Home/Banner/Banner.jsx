...
export const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full ">
    <img src={img1} alt='banner' className="w-full rounded-xl" />
    <div className="absolute rounded-xl h-full flex items-center space-x-4 left-0 top-0 bg-gradient-to-r from-[#151515] to-[#15151500]">
     <div className='text-white pl-12 space-y-4'>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    <img src={img2} alt='banner' className="w-full rounded-xl" />
    <div className="absolute rounded-xl h-full flex items-center space-x-4 left-0 top-0 bg-gradient-to-r from-[#151515] to-[#15151500]">
     <div className='text-white pl-12 space-y-4'>
        <h1 className='text-5xl font-bold w-1/3'>Affordable Price For Car Servicing</h1>
        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
  ...
  <div id="slide4" className="carousel-item relative w-full rounded-xl">
    ...
    <div className="absolute h-full rounded-xl flex items-center space-x-4 left-0 top-0 bg-gradient-to-r from-[#151515] to-[#15151500]">
     <div className='text-white pl-12 space-y-4'>
        <h1 className='text-5xl font-bold w-1/3'>Affordable Price For Car Servicing</h1>
        <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
        <div className='space-x-5'>
